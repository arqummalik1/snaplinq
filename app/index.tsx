            ...
            <View className="absolute top-0 left-0 right-0 z-20 bg-white/90 dark:bg-slate-900/90 border-b border-slate-200/50 dark:border-slate-800/50 backdrop-blur-xl">
                ...
                <View className="pt-10 pb-2 px-4 flex-row items-center justify-between">
                    ...
                    <View className="flex-row items-center gap-1.5">
                        ...
                        >
                            {isDark ? <Sun size={16} color="#fcd34d" /> : <Moon size={16} color="#64748b" />}
                        </Pressable>

                        <Pressable
                            onPress={() => { setEditingLink(null); setShowAddModal(true); }}
                            className="w-8 h-8 bg-emerald-500 rounded-lg items-center justify-center shadow-sm"
                        >
                        ...
                        <Pressable
                            onPress={signOut}
                            className="w-8 h-8 items-center justify-center rounded-lg bg-red-50 dark:bg-red-900/20"
                        >
                ...
                <View className="px-4 pb-3">
                    <View className="relative">
                        <View className="absolute left-3 top-2.5 z-10 opacity-60">
                            <Search size={16} color={isDark ? '#cbd5e1' : '#64748b'} />
                        </View>
                        <Input
                            className="pl-10 h-10 rounded-xl bg-slate-100/80 dark:bg-slate-800/50 border border-slate-200 dark:border-slate-700/50 text-sm"
